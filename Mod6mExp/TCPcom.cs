...
namespace Machine
{
    ...
    public class TCPcom
    {
        ...
        public TCPcom(ref mcOMRON.OmronPLC plcInstance)
        {
            ...
            thWork = new Thread(new ThreadStart(WorkThreadMethod));
            thWork.Name = "TCPcom";
        ...
        private void WorkThreadMethod()
        {
            ...
            while (true)
            {
                //if (!MainWindow.plc.Connected) continue;
    ...
    {
        public char cmdID { set; get; }
        public mcOMRON.MemoryArea memArea { set; get; }
        public ushort RegAddress { set; get; }
        public byte BitPosition { set; get; }
        public byte BitValue { set; get; }
        public ushort WordValue { set; get; }
        public uint DWordValue { set; get; }
    }
}
